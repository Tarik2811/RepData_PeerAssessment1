...
```{r Daily Total steps Avg, echo=FALSE}
...
```{r Daily Total steps imputed missing data , echo=FALSE}
...
```{r difference in activity patterns between weekdays & weekends, echo=FALSE}
knitr::opts_chunk$set(echo = TRUE)
